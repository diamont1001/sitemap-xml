...
class SubSitemap {
   ...
   * @param {Number} mobile 移动支持
   * @return {void} -
   */
  constructor(filePath = './sitemap/', type = '', changefreq, priority, mobile) {
    this.type = type;
    this.filePath = filePath;

    this.lastmod = Utils.stampFormat2Date('Y-m-d', Date.now());
